...
```js
import { domShimSymbol } from 'https://cdn.spooky.click/dom-shim/1.1.1/mod.js';
...
```js
import 'https://cdn.spooky.click/dom-shim/1.1.1/mod.js?global';
```

You can use the `unshim` export to remove the globals if you only want them available temporarily.

```js
import { unshim } from 'https://cdn.spooky.click/dom-shim/1.1.1/mod.js?global';
...
```js
import 'https://cdn.spooky.click/dom-shim/1.1.1/mod.js?global&props=HTMLDivElement,HTMLParagraphElement,customElements';
```
